...
class Config(object):
    def __init__(self, ):
        ...
        data_code_dict = {
            ...
            'mynetwork': '512x512_256x256_dist',
            'dist': '536x536_84x84',
        ...
        self.train_dir = ['data/Train/%s/' % data_code_dict[self.model_type]]
        print(self.train_dir)
        self.valid_dir = ['data/Valid/%s/' % data_code_dict[self.model_type]]
        ...
        self.inf_data_dir = 'data/Test/Images/'
    ...
    def get_train_augmentors(self, input_shape, output_shape, view=False):
        ...
        label_augs = []
        if self.model_type == 'unet' or self.model_type == 'micronet' or self.model_type == 'mynetwork':
